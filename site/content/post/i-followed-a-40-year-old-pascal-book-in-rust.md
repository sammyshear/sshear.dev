...
description: When Elementary Pascal was published in 1982, the world of
  ...
  IRS, C++ would appear in 3 years, and Rust would take another 24. Most
  languages in use would have looked quite strange to the modern developer, as
  C-style hadn't quite taken over. So what would it look like if we rewrote the
